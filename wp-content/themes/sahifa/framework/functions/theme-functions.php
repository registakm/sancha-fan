...
<div class="author-bio">
	...
	<?php  if( $social ) :	?>	
		<div class="author-social flat-social">
			...
			<a class="social-site" href="<?php echo esc_url( get_the_author_meta( 'url' , $user_id ) ); ?>" target="_blank"><i class="fa fa-home"></i></a>
			<?php endif ?>	
			<?php if ( get_the_author_meta( 'facebook' , $user_id ) ) : ?>
			<a class="social-facebook" href="<?php echo esc_url( get_the_author_meta( 'facebook' , $user_id ) ); ?>" target="_blank"><i class="fa fa-facebook"></i></a>
			<?php endif ?>
			<?php if ( get_the_author_meta( 'twitter' , $user_id  ) ) : ?>
			<a class="social-twitter" href="http://twitter.com/<?php the_author_meta( 'twitter' , $user_id ); ?>" target="_blank"><i class="fa fa-twitter"></i><span> @<?php the_author_meta( 'twitter' , $user_id ); ?></span></a>
			<?php endif ?>
			<?php if ( get_the_author_meta( 'google' , $user_id ) ) : ?>
			<a class="social-google-plus" href="<?php echo esc_url( get_the_author_meta( 'google' , $user_id ) ); ?>" target="_blank"><i class="fa fa-google-plus"></i></a>
			<?php endif ?>	
			<?php if ( get_the_author_meta( 'linkedin' , $user_id ) ) : ?>
			<a class="social-linkedin" href="<?php echo esc_url( get_the_author_meta( 'linkedin' , $user_id ) ); ?>" target="_blank"><i class="fa fa-linkedin"></i></a>
			<?php endif ?>				
			<?php if ( get_the_author_meta( 'flickr' , $user_id ) ) : ?>
			<a class="social-flickr" href="<?php echo esc_url( get_the_author_meta( 'flickr' , $user_id ) ); ?>" target="_blank"><i class="fa fa-flickr"></i></a>
			<?php endif ?>	
			<?php if ( get_the_author_meta( 'youtube' , $user_id ) ) : ?>
			<a class="social-youtube" href="<?php echo esc_url( get_the_author_meta( 'youtube' , $user_id ) ); ?>" target="_blank"><i class="fa fa-youtube"></i></a>
			<?php endif ?>
			<?php if ( get_the_author_meta( 'pinterest' , $user_id ) ) : ?>
			<a class="social-pinterest" href="<?php echo esc_url( get_the_author_meta( 'pinterest' , $user_id ) ); ?>" target="_blank"><i class="fa fa-pinterest"></i></a>
			<?php endif ?>
			<?php if ( get_the_author_meta( 'behance' , $user_id ) ) : ?>
			<a class="social-behance" href="<?php echo esc_url( get_the_author_meta( 'behance' , $user_id ) ); ?>" target="_blank"><i class="fa fa-behance"></i></a>
			<?php endif ?>
			<?php if ( get_the_author_meta( 'instagram' , $user_id ) ) : ?>
			<a class="social-instagram" href="<?php echo esc_url( get_the_author_meta( 'instagram' , $user_id ) ); ?>" target="_blank"><i class="fa fa-instagram"></i></a>
			<?php endif ?>	
		</div>
	<?php endif; ?>
	<div class="clear"></div>
