		...
		<div id="tab6" class="tab_content tabs-wrap">
			...
			<div class="tiepanel-item">
				...
				<?php
					...
					tie_options(
						array(	"name"	=> __( 'Hatena Button', 'tie' ),
								"id"	=> "share_hatena",
								"type"	=> "checkbox"));

					tie_options(
						array(	"name"	=> __( 'LINE Button', 'tie' ),
								"id"	=> "share_line",
								"type"	=> "checkbox"));
				?>
			</div>
			...
			<div class="tiepanel-item">
				...
				<h3><?php _e( 'Custom Social Share Button', 'tie' ) ?></h3>
				<?php
					tie_options(
						array(	"name"	=> __( 'Custom Share Button', 'tie' ),
								"id"	=> "custom_share_button",
								"type"	=> "checkbox"));

					tie_options(
						array(	"name"	=> __( 'Twitter', 'tie' ),
								"id"	=> "custom_share_T",
								"type"	=> "checkbox"));

					tie_options(
						array(	"name"	=> __( 'Facebook', 'tie' ),
								"id"	=> "custom_share_F",
								"type"	=> "checkbox"));

					tie_options(
						array(	"name"	=> __( 'Line(mobile only)', 'tie' ),
								"id"	=> "custom_share_L",
								"type"	=> "checkbox"));
				?>
			</div>
