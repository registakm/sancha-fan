...
<div class="<?php echo $share_box_class ?>">
	...
	<?php if( tie_get_option( 'share_tweet' ) ): ?>
		<li><a href="http://twitter.com/share?url=<?php echo $post_link; ?>&text=<?php the_title(); ?>&via=<?php if( tie_get_option( 'share_twitter_username' )) echo 'via @'.tie_get_option( 'share_twitter_username' ); ?>" class="social-twitter" rel="external" target="_blank"><i class="fa fa-twitter"></i> <span><?php _eti( 'Twitter' );?></span></a></li>
	<?php endif; ?>
	<?php if( tie_get_option( 'share_google' ) ): ?>
		<li><a href="https://plusone.google.com/_/+1/confirm?hl=ja&amp;url=<?php echo $post_link; ?>&amp;name=<?php the_title(); ?>" class="social-google-plus" rel="external" target="_blank"><i class="fa fa-google-plus"></i> <span><?php _eti( 'Google +' );?></span></a></li>
	<?php endif; ?>
	...
	(function(w, d, s) {
	  function go(){
		...
		load('//connect.facebook.net/ja/all.js#xfbml=1', 'fbjssdk');
